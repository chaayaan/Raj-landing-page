...
<nav class="rg-nav" id="rgNavbar">
  ...
  <div class="rg-nav-social">
    <a href="https://facebook.com/YOUR_PAGE" target="_blank" rel="noopener" class="rg-social-btn rg-fb" title="Facebook">
...
<nav class="rg-mobile-menu" id="rgMobileMenu">
  ...
  <a href="#about"           onclick="rgCloseMenu()">About</a>
  <a href="products.php"     onclick="rgCloseMenu()">Products</a>
  <a href="#gallery"         onclick="rgCloseMenu()">Gallery</a>
  <a href="#clients"         onclick="rgCloseMenu()">Clients</a>
  <a href="sister-concern.php" onclick="rgCloseMenu()">Sister Concern</a>
  <a href="#contact"         onclick="rgCloseMenu()">Contact</a>
  <div class="rg-mob-social">
    <a href="https://facebook.com/YOUR_PAGE" target="_blank" rel="noopener" class="rg-fb" onclick="rgCloseMenu()">
    ...
    <a href="https://wa.me/8801716469866" target="_blank" rel="noopener" class="rg-wp" onclick="rgCloseMenu()">
