  ...
  <div class="rg-footer-top">
    ...
    <div class="rg-footer-col rg-footer-col-brand">
      <div class="rg-footer-brand">
        <img src="logo.jpg" alt="Raj Aiswari" width="90" height="45"
      ...
      <div class="rg-footer-socials">
        <a href="https://facebook.com/YOUR_PAGE" target="_blank" rel="noopener" class="rg-footer-social rg-footer-social-fb" title="Facebook">
    ...
    <div class="rg-footer-col">
      ...
      <ul class="rg-footer-linklist">
        <li><a href="sister-concern.php">Sister Concerns</a></li>
        <li><a href="employees.php">Our Team</a></li>
...
.rg-footer-brand img {
  width: 90px; height: 45px; object-fit: contain;
  opacity: 0.9;
}
.rg-footer-brand-fallback {
  font-family: 'Cormorant Garamond', serif;
  font-size: 1.3rem; font-weight: 600;
  color: var(--rg-gold-light); letter-spacing: 0.05em;
}
.rg-footer-tagline {
...
.rg-footer-col-title {
  ...
  margin-bottom: 18px;
  padding-bottom: 10px;
  border-bottom: 1px solid rgba(184,136,30,0.2);
}
...
.rg-footer-contact-list svg {
  color: var(--rg-gold); flex-shrink: 0; margin-top: 3px;
}
...
(function () {
  ...
  function slideTo(idx) {
    ...
    if (sdots[cur]) sdots[cur].classList.remove('rg-active');
    cur = (idx + slides.length) % slides.length;
    slides[cur].classList.add('rg-active');
    if (sdots[cur]) sdots[cur].classList.add('rg-active');
  }
